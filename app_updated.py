...
DATA_RAW    = os.path.join(BASE_DIR, "FraudShield_Banking_Data.csv")
DATA_CLEAN  = os.path.join(BASE_DIR, "cleaned_data.csv")
DATA_FEAT   = os.path.join(BASE_DIR, "featured_data.csv")
